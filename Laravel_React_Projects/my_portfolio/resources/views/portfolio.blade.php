                        ...
                        <div class="col-md-6">
                            <div data-aos='fade-up' data-aos-duration="1000" class="form-group">
                                ...
                                <input type="text" name="phone" class="form-control" placeholder="000008801324xxx"
                                    value="{{ old('phone') }}">
                                @if ($errors->has('phone'))
                                    <span class="text-danger">{{ $errors->first('phone') }}</span><span class="text-danger">
                                        Not
                                        {{ strlen(old('phone')) }}</span>
                                @endif
                            </div>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="row subject-input">
                        <div class="col-md-12">
                            <div data-aos='fade-up' data-aos-duration="1000" class="form-group">
                                ...
                                <textarea name="msg" rows="3" class="form-control" placeholder="Can you build website at low cost?">{{ old('msg') }}</textarea>
                                @if ($errors->has('msg'))
