    ...
    return (
        <div>
            <div className=''>
                <section>
                    <div>
                        <h1 className='text-center'><b>eCommerce Website</b></h1>
                    </div>
...
const Product = ({ id, img, title, text, OP }) => {
    return (
        <article data-aos='fade-left'
            data-aos-anchor-placement="bottom-center" className='shadow-drop-2-center' style={{ backgroundImage: `url(${img})`, padding: '10%' }}>
            <p>#{id}</p>
            <h1>{title}</h1>
            <div>
                <h6>{text}</h6>
